...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, default='long_term_forecast',
                        help='task name, we currently support only long_term_forecast, options:[long_term_forecast, classification]')
    parser.add_argument('--is_training', type=int, default=1, help='status')
    parser.add_argument('--model_id', type=str, default='temp', help='model id')
    parser.add_argument('--model', type=str, default='TimesNet',
                        help='model name, options: [RAFT, Dlinear, RMTS_feature, RMTS_latent, TimesNet, TimeXer]')
    ...
    # parser.add_argument('--use_no_retrieval', action='store_true')  
    ...
    parser.add_argument(
        ...
        type=str, 
        default='no_rag',
        choices=['no_rag', 'feature_rag', 'latent_rag'],
        help='Type of RAG to use: no_rag (default), feature_rag (original features), or latent_rag (latent space)'
    )
    ...
    parser.add_argument('--contrastive_batch', type=int, default=64)
