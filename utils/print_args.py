def print_args(args):
    ...
    print("\033[1m" + "Retrieval / Contrastive Learning" + "\033[0m")
    print(f'  {"RAG Type:":<20}{args.rag_type:<20}{"Retrieve Encoder:":<20}{args.retrieve_encoder:<20}')
    print(f'  {"Contrastive Loss:":<20}{args.contrastive_loss:<20}{"Mining Temp:":<20}{args.mining_temp:<20}')
    print(f'  {"Latent Dim:":<20}{args.latent_dim:<20}{"Encoder Epochs:":<20}{args.encoder_epochs:<20}')
    print()
